...
Shipping honestly means naming the limits: it is distributed through GitHub Releases only, with no browser-store installation, extraction is heuristic, and token counts are estimates. Those are documented rather than smoothed over.
